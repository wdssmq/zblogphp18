...
if ('' != GetVars('restore', 'GET')) {
    ...
    if (false === stripos($hash, $crc32) && false === stripos($hash, $md5) && false === stripos($hash, $md5_r) && false === stripos($hash, $md5_n)) {
        exit;
    }
