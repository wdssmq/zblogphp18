...
<div class="post" id="divCommentPost">
	<p class="posttop"><span>{if $user.ID>0}{$user.StaticName}{/if}{$lang['default']['add_reply']}:</span><a rel="nofollow" id="cancel-reply" href="#divCommentPost" style="display:none;"><small>{$lang['default']['cancel_reply']}</small></a></p>
