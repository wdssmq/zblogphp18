<div class="content wide">
	<div class="block">
		<div class="post">
			...
			<div class="single{if $type == 'page' && $zbp->Config('tpure')->PostVIEWALLPAGEON && tpure_viewall($article->Metas->viewall)} viewall{/if}{if $zbp->Config('tpure')->PostINDENTON == '1'} indent{/if}{if $zbp->Config('tpure')->PostTIMGBOXON == '1'} timgbox{/if}">
				{php}
