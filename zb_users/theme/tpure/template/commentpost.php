...
{else}
			<div class="cmtform">
				...
				{if $zbp->Config('tpure')->PostCMTMAILON}<p><input type="text" name="inpEmail" id="inpEmail" class="text" size="28" tabindex="3"><label for="inpEmail">{$lang['tpure']['inp_email']}{if $zbp->Config('tpure')->PostCMTMAILNOTNULLON}(*){/if}</label></p>{else}<input type="hidden" name="inpEmail" id="inpEmail">{/if}
